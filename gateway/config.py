...
class GatewayConfig:
    ...
    _SCALAR_DICT_FIELDS = (
        ...
        "stt_delete_audio_after_transcription", "stt_echo_transcripts", "group_sessions_per_user", "thread_sessions_per_user",
    ...
    def from_dict(cls, data: Dict[str, Any]) -> "GatewayConfig":
        ...
        return cls(
            ...
            **{name: _coerce_bool(data.get(name), default) for name, default in _TOPLEVEL_BOOL_DEFAULTS.items()},
            ...
            stt_delete_audio_after_transcription=_coerce_bool(stt_setting("stt_delete_audio_after_transcription", "delete_audio_after_transcription"), False),
